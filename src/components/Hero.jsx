  ...
  (
    <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <div className="flex flex-col items-center  py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2">
        ...
        <div className= {`ss:flex hidden md:mr-4 mr-0 ${styles.glowEffect}`}>
        <GetStarted/>
